...
GR2.GrannyVersionsMatch = function(GrannyProductMajorVersion, GrannyProductMinorVersion, GrannyProductCustomization, GrannyProductBuildNumber) {

};


GR2.File = function (input) { // GrannyReadEntireFile or GrannyReadEntireFileFromMemory
...
GR2.Node = function Node( gr2, fp, only ) {
    var i, j, count, version = gr2.version;
